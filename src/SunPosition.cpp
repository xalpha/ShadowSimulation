...
double SunPosition::degToDouble(int deg[3])
{
...
bool SunPosition::isLeapYear(int year)
{
    return ((year % 4 == 0 && year % 100 != 0) || year % 400 == 0);
}


int SunPosition::dayOfTheYear(int year,int month,int day)
{
...
/*
int SunPosition::minuteOfTheYear(int year,int month,int day, int hour, int minute)
{
...
void SunPosition::setPosition(int latitude1[3], int longitude1[3], float timeZone1)
{
...
void SunPosition::setDate( Date inputDate)
{
    year = inputDate.year;
